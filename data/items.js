...
module.exports = [
    ...
    { name: 'Premium', id: 8, icon: `${market.premium.icon}`, price: `${market.premium.price}`, type: 'b', description: `${market.premium.description}` },
    { name: 'Face Mask', id: 9, icon: `${market['face-mask'].icon}`, price: `${market['face-mask'].price}`, type: 's', index: 944, description: `${market['face-mask'].description}` },
    { name: 'Antidote xvi', id: 10, icon: `${market.antidote.icon}`, price: `${market.antidote.price}`, type: 's', index: 1659, description: `${market.antidote.description}` }];
