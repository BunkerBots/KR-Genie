...
import { emotes, crime } from '../../data';
import { utils as _utils } from '../../modules';
import comma from '../../modules/comma';
import { createEmbed } from '../../modules/messageUtils';
import { addXP } from '../../mongo';

export const name = 'crime';
export const aliases = ['crime'];
export const cooldown = 900;
export const description = `A command to bag good amount of ${emotes.kr}. Beware with great rewards comes great risks. There is a 10% chance that you will die and lose all your coins, 40% chance of failure and 50% chance of success`;
export const expectedArgs = 'k/crime';
