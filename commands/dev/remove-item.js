...
export const name = 'removeitem';
export const aliases = ['delitem'];
export const cooldown = 10;
export const description = 'A command used to buy items/collectables/skins from the shop';
export const expectedArgs = 'k/buy (item name)';
export const manualStamp = true;
